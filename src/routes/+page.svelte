        ...
        <Card href={book.url} classes='!p-0 !border-gray-200 !border-l-0 !w-[12.89rem] !rounded-r-sm !bg-gray-50'>
            <div class='flex rounded-lg'>
                ...
                <div class='w-full'>
                    ...
                    <div class='absolute top-0 h-full bg-white opacity-0 hover:opacity-100 transition-opacity p-4 text-sm text-gray-600 pl-5 rounded-r-sm'>{book.description}</div>
                </div>
            </div>
        </Card>
        {/snippet}
